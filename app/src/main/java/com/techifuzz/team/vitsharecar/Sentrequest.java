 ...
 */
public class Sentrequest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_sentrequest, container, false);
        final FirebaseUser current_user= FirebaseAuth.getInstance().getCurrentUser();
        String uid=current_user.getUid();
        textView=(TextView) root.findViewById(R.id.norequest1);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("sent").child(uid);
        recyclerView=(RecyclerView) root.findViewById(R.id.userlist2);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    FirebaseRecyclerAdapter<User, Request.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, Request.UserViewHolder>(
                            User.class,
                            R.layout.user_single_item_request,
                            Request.UserViewHolder.class,
                            databaseReference

                    ) {
                        @Override
                        protected void populateViewHolder(Request.UserViewHolder viewHolder, final User user, int position) {
